...
*/					
                    ...
                    $query = $this->db->query("INSERT INTO `blogs`( `blog_title`, `blog_desc`, `blog_img`) VALUES ('$blog_title','$desc','$fileurl')");
	...
	function editblog($blog_id){
		//print_r($blog_id);
		$query = $this->db->query("SELECT  `blog_title`, `blog_desc`, `blog_img`, `status` FROM `blogs` WHERE `blogid`='$blog_id'");
		...
		if ( $_FILES['file']['name'] ) {
            ...
            else
            {
					...
					*/
                    ...
                    $query = $this->db->query("UPDATE `blogs` SET `blog_title`='$blog_title',`blog_desc`='$desc',`blog_img`='$filename_location', `status`='$publish_unpublish' WHERE `blogid`='$blog_id'");
            ...
            $query = $this->db->query("UPDATE `blogs` SET `blog_title`='$blog_title',`blog_desc`='$desc', status='$publish_unpublish' WHERE `blogid`='$blog_id'");
	...
	function deleteblog(){
		...
		$qu = $this->db->query("DELETE FROM `blogs` WHERE `blogid`='$delete_id'");
